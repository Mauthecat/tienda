...
const Header = () => {
    ...
    return ( // CORRECCIÓN AQUÍ: Se cambió "दल" por "("
        <header className="bg-[#b3f3f5] shadow-sm sticky top-0 z-50 w-full transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16 relative">
                    ...
                    {/* ICONOS DERECHA (Unificado para Móvil y PC) */}
                    <div className="flex items-center space-x-2 md:space-x-6 z-10">
                        ...
                        {/* El carrito ahora SIEMPRE está visible */}
                        <button className="relative p-2 text-gray-800 hover:text-indigo-600">
                            <ShoppingCart size={24} />
                            <span className="absolute top-0 right-0 md:-top-1 md:-right-2 bg-indigo-600 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">0</span>
                        </button>
                    </div>
                </div>
            </div>
